export default function QuantityInput({
  ...
  return (
    <div className='relative flex flex-row h-8 mt-1 flex-0'>
      ...
      <input
        className='flex items-center w-4 h-full text-sm font-thin font-semibold text-center text-white bg-indigo-600 rounded-none outline-none focus:outline-none md:text-basecursor-default'
        type='number'
        min={min}
        max={max}
        value={quantity}

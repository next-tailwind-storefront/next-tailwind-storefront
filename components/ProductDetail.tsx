...
export default function ProductDetail({ loading, node }: { loading?: boolean; node?: ProductFragment }) {
      ...
      <section className='overflow-hidden text-gray-600 body-font'>
        <div className='container px-5 py-12 mx-auto lg:py-24'>
          <div className='flex flex-wrap mx-auto lg:w-full'>
            <div className='relative block w-full h-64 lg:w-1/2 lg:h-96 skeleton-blocks'>
              <ProductImage alt={node?.images.edges?.[0]?.node.altText} src={node?.images.edges?.[0]?.node.mediumSrc} />
            </div>
            <div className='w-full pt-6 lg:w-1/2 lg:pl-10 lg:pb-6 lg:pt-0'>
              ...
              <div className='flex'>
                ...
                <AddToCartButton variantId={first(node?.variants.edges)?.node.id} {...cartContext} />

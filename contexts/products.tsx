...
import { CollectionLoaderContextProps, Expand, ProductFragment, ProductsQuery } from 'types'
import { PRODUCTS } from 'graphql/queries'
import { DevelopmentContext } from './development'

const BATCH_SIZE = 8

export const ProductsContext = createContext({} as Expand<CollectionLoaderContextProps<ProductFragment>>)
